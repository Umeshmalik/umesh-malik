...
>
  ...
  <div
    class="relative z-10 mx-auto w-full max-w-[1160px] hero-stagger"
    class:mounted
  >
    <p class="label-mono mb-8 text-brand-accent hero-item">Software Engineer</p>
    <h1 class="hero-headline mb-10 text-brand-text-primary hero-item">
      I build scalable<br class="hidden md:block" />
      software <span class="text-brand-accent">systems</span>.
    </h1>
    <p class="body-large mb-14 max-w-2xl text-brand-text-secondary hero-item">
    ...
    <div class="flex flex-wrap gap-4 hero-item">
      <Button variant="primary" size="lg" href="/resume">View Resume</Button>
      <Button variant="secondary" size="lg" href="/projects">View Work</Button>
    </div>
  </div>
</section>
