...
<SEO
  ...
  description="The tools, hardware, and software I use daily as a Software Development Engineer. Editor setup, terminal config, browser extensions, and development stack."
/>
...
<section class="mx-auto max-w-[1160px] px-6 pt-32 pb-20 lg:px-12">
  ...
  <p class="body-large mb-16 text-brand-text-secondary">
    The hardware, software, and workflows I rely on every day. Updated
              ...
              >
                <h3 class="mb-2 text-lg font-medium text-brand-text-primary">
                  {#if item.url}
                    ...
                    >
                      {item.name}
                      <span class="text-brand-text-muted" aria-hidden="true"
                        >↗</span
                      >
                    </a>
                  {:else}
