...
<SEO
  ...
  description="Curated collection of software development resources, tools, libraries, blogs, podcasts, and reusable code snippets that I use and recommend."
/>
...
<section class="mx-auto max-w-[1160px] px-6 pt-32 pb-20 lg:px-12">
  ...
  <div>
    ...
    <p class="body-large mb-10 text-brand-text-secondary">
      Reusable patterns I reach for frequently. Copy, adapt, and use in your own
      projects.
    </p>
